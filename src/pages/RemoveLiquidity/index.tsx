                  ...
                  <AutoColumn gap="10px">
                    ...
                    {chainId && (oneCurrencyIsNativeWrapper || oneCurrencyIsNative) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsNative ? (
                          <StyledInternalLink
                            to={`/remove/${currencyA === nativeCurrency ? nativeCurrencyWrapper?.address : currencyIdA
                          ...
                          <StyledInternalLink
                            to={`/remove/${currencyA && nativeCurrencyWrapper && currencyEquals(currencyA, nativeCurrencyWrapper)
