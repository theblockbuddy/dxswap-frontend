...
import { injected, walletlink, uauth, bitKeepInjected } from '../connectors';
...
export const USDT: { [key: number]: Token; } = {
  ...
  [ChainId.ESPENTO]: new Token(ChainId.ESPENTO, '0xc929Be511347Cd4133fC22d4eA405fc3161c12A5', 6, 'USDT', 'Espento USD')
};
...
// export const USDT = new Token(ChainId.ESPENTO, '0xc929Be511347Cd4133fC22d4eA405fc3161c12A5', 18, 'USDT', 'USDT from Espento');
