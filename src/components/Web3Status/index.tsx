...
import { NETWORK_DETAIL, NetworkContextName } from '../../constants';
import useENSName from '../../hooks/useENSName';
import { useAddPopup, useCloseModals, useWalletModalToggle } from '../../state/application/hooks';
    ...
    return (
      <>
        ...
        <NetworkSwitcherPopover>
          <div onClick={() => selectNetwork(9911)}>
            <Web3StatusNetwork>
              <IconWrapper size={20}>
                <img src={ChainLogo[networkConnectorChainId]} alt={''} />
              </IconWrapper>
              <TYPE.white ml="8px" padding="8px" mr={!!!account ? '4px' : '0px'} fontWeight={700} fontSize="12px">
